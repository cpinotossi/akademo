var websocketclient = {
    ...
    'connect': function () {
        ...
        var clientId = jwtPayload.clientID;
...
*/
    ...
    'onConnect': function () {
        console.log(Date.now() +" : "+ new Date().toLocaleString()+":onConnect");
    ...
    'onFail': function (message) {
        ...
        console.log(Date.now() +" : error: " + message.errorMessage);
    ...
    'onConnectionLost': function (responseObject) {
        ...
        if (responseObject.errorCode !== 0) {
            console.log(Date.now() +" : onConnectionLost:" + responseObject.errorMessage);
        }
    ...
    'onMessageArrived': function (message) {
        console.log(Date.now() +" : "+ new Date().toLocaleString()+":onMessageArrived");
    ...
    'publish': function (topic, payload, qos, retain) {
        console.log(Date.now() +" : "+ new Date().toLocaleString()+":publish");
