...
//    	    	break;
    ...
    ClientImpl.prototype._doConnect = function (host, port, path) {
        // When the socket is open, this client will send the CONNECT WireMessage using the saved parameters.
        console.log("this.connectOptions.useSSL:"+this.connectOptions.useSSL);
        console.log("this.connectOptions.userName:"+this.connectOptions.userName);
        console.log("this.connectOptions.jwt:"+this.connectOptions.jwt);
        if (this.connectOptions.useSSL){
            var jwt = this.connectOptions.jwt;
            wsurl = ["wss://", host, ":", port, "/mqtt", "?jwt=", jwt].join("");
        } else{
    ...
    ClientImpl.prototype._disconnected = function (errorCode, errorText) {
        ...
        if (this.connectOptions.hosts && this.hostIndex < this.connectOptions.hosts.length - 1) {
            // Try the next host.
            this.hostIndex++;
            this._doConnect(this.connectOptions.hosts[this.hostIndex], this.connectOptions.ports[this.hostIndex], this.connectOptions.jwt);
